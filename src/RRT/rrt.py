...
def init_obstacles(configNum):  #initialized the obstacle
    ...
    if (configNum == 1):
        ...
        rectObs.append(pygame.Rect((100,100),(100,350)))
	rectObs.append(pygame.Rect((320,250),(150,150)))
	#rectObs.append(pygame.Rect((320,270),(50,250)))
	#rectObs.append(pygame.Rect((370,250),(200,50)))
	#rectObs.append(pygame.Rect((570,250),(50,150)))
	rectObs.append(pygame.Rect((500,50),(200,100)))
    if (configNum == 2):
        rectObs.append(pygame.Rect((100,50),(200,150)))
    if (configNum == 3):
        rectObs.append(pygame.Rect((100,50),(200,150)))
