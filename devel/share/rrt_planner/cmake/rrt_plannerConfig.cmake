...
if("TRUE" STREQUAL "TRUE")
  set(rrt_planner_SOURCE_PREFIX /home/jerryrain/rrt_ws/src/ROS_RRT/src/rrt_planner_3)
  set(rrt_planner_DEVEL_PREFIX /home/jerryrain/rrt_ws/devel)
  ...
  set(rrt_planner_INSTALL_PREFIX /home/jerryrain/rrt_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'gjx <974186763@qq.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rrt_planner' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'rrt_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jerryrain/rrt_ws/src/ROS_RRT/src/rrt_planner_3/${idir}'.  ${_report}")
    endif()
...
set(depends "roscpp;rospy;std_msgs;nav_core;pluginlib;costmap_2d")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${rrt_planner_dep}_FOUND)
      find_package(${rrt_planner_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${rrt_planner_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
