...
(cl:defclass <MoveActionGoal> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (goal
    :reader goal
    :initarg :goal
    :type lqrrt_ros-msg:MoveGoal
    :initform (cl:make-instance 'lqrrt_ros-msg:MoveGoal)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <MoveActionGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveActionGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lqrrt_ros-msg:<MoveActionGoal> is deprecated: use lqrrt_ros-msg:MoveActionGoal instead.")))
...
(cl:defmethod goal_id-val ((m <MoveActionGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lqrrt_ros-msg:goal_id-val is deprecated.  Use lqrrt_ros-msg:goal_id instead.")
  (goal_id m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<MoveActionGoal>)))
  ...
  "e99f42e1b2ea344edd312a6763eac96c")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'MoveActionGoal)))
  "Returns md5sum for a message object of type 'MoveActionGoal"
  "e99f42e1b2ea344edd312a6763eac96c")
